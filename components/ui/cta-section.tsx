  ...
  return (
    <section className="anchor-section pb-8 pt-12 sm:pt-[4.75rem]" id={id}>
      <Container>
        <Reveal
          className={cn(
            "booking-surface overflow-hidden border border-brand-stone/75 text-brand-ink shadow-soft",
            isCompact
        ...
        >
          <div className={cn("flex flex-col gap-8 lg:flex-row lg:justify-between", isCompact ? "lg:items-center" : "lg:items-end")}>
            <div className={cn("space-y-4", isCompact ? "max-w-xl" : "max-w-2xl space-y-5")}>
            ...
            <div className={cn("flex flex-col gap-3 sm:flex-row", isCompact ? "lg:justify-end" : "lg:max-w-sm lg:justify-end")}>
              <Button href={content.primaryCta.href} {...primaryProps}>
                {content.primaryCta.label}
              </Button>
              <Button href={content.secondaryCta.href} variant="secondary" {...secondaryProps}>
